 ...
 */
final class Version20200826101453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP show_time_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD show_time_id INT DEFAULT NULL');
    }
}
